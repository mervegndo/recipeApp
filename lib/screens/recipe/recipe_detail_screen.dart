            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // ── Kullanıcı kartı — profile yönlendirir ──
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => UserProfileScreen(
                            ...
                            userName: recipe.userEmail.split('@').first,
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: Center(
                              child: Text(
                                recipe.userEmail.isNotEmpty
                                    ? recipe.userEmail[0].toUpperCase()
                                    : 'U',
                                style: const TextStyle(
                                  color: Colors.white,
